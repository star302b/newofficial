...
<head>
    ...
    <?php 
    if( $_SERVER['HTTP_HOST'] == 'bitcoindecode.com' ):
    ?>
<!-- Google Tag Manager -->
...
})(window,document,'script','dataLayer','GTM-5J4787Q');</script>
...
<?php if ( get_field('theme_variant','option') == 'v4' ): ?>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5J4787Q"
