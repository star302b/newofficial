        ...
        <div class="container">
            ...
            <div class="row flex-row flex-align-center flex-wrap-xs">
                <div class="col col-md-50">
                    <img width="500" height="500" src="<?php echo get_template_directory_uri()?>/themes/purple-blue/assets/img/hero/hero-img-2.png" alt="<?php echo get_global_option('newofficial_funnel')?>">
                </div>
                <div class="col col-md-50">
