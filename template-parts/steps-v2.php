...
?>
<section class="lazy content-section steps-section steps-section--variant-2 dark-section section-overlay" data-bg="<?php echo IMAGE_URL; ?>imgm/content/pexels-olya-kobruseva-8919570.jpeg" data-name="Steps" data-description="Variant 2">
