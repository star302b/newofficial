...
<section class="lazy hero-banner" data-bg="<?php if( get_field('background_image1','option')): echo get_field('background_image1','option'); else: ?><?php echo IMAGE_URL; ?>imgm/hero/hero-bg-3.jpeg<?php endif; ?>"  data-name="Hero Banner" data-description="With Video, Form-Right">
