...
<section class="content-section light-section" data-name="Article" data-description="Left image">
    <div class="container">
        <div class="fow flex-row flex-align-center flex-md-reverse">
            ...
            <div class="col col-md-50">
                <img class="lazy" data-src="<?php if( empty( get_field('background_image2','option') ) ): echo IMAGE_URL; ?>imgm/content/pexels-alesia-kozik-6777570.jpeg<?php else: echo get_field('background_image2','option'); endif; ?>" alt="Start Growing Your Financial Portfolio Today">
            </div>
        </div>
    </div>
</section>