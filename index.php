...
<?php 
if (!$site_all_content = get_transient('site_all_content_5_' . $theme_version . '_' . ICL_LANGUAGE_CODE)):
    ob_start();
...
set_transient( 'site_all_content_5_' . $theme_version . '_' . ICL_LANGUAGE_CODE, $site_all_content, 60 * 60 * 60 );
endif;
